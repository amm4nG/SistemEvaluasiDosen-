...
@section('content')
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('dosen') }}" class="nav-link active">
                            ...
                            <ul class="nav nav-treeview">
                                @if ($id == 1)
                                    <li class="nav-item">
                                        <a href="{{ route('dosen.show', 1) }}" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Informatika</p>
                                        </a>
                                    </li>
                                ...
                                @elseif ($id == 2)
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('dosen.show', 2) }}" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Sipil</p>
                                        </a>
                                    </li>
                                ...
                                @else
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('dosen.show', 3) }}" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>PWK</p>
                                        </a>
                                    </li>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <h3 class="text-capitalize">Dosen {{ $prodi->nama_prodi }}</h3>
                                    <label for="">upload file daftar dosen</label>
                                    @if ($errors->any())
                                    ...
                                    <form action="{{ route('dosen.store') }}" method="post"
                                        ...
                                        @csrf
                                        <input type="hidden" value="{{ $id }}" name="id_prodi"
                                            id="">
                                    ...
                                    <table id="dosen" class="table table-sm table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>NIDN</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('dosen.destroy', $d->id) }}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <a data-toggle="modal" id="btn-edit-dosen" data-dosen="{{ $d->id }}" data-target="#edit-dosen" class="btn btn-warning btn-sm"><i
            ...
            <form action="{{ route('tambah-dosen.store') }}" method="post">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" value="{{ $id }}" name="id_prodi" id="">
                        <input type="text" required placeholder="NIDN" class="form-control mb-2" name="nidn"
                            id="">
                        <input type="text" required placeholder="Nama Dosen" class="form-control mb-2"
                            name="nama_dosen" id="">
                    </div>
    ...
    <div class="modal fade" id="edit-dosen" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
